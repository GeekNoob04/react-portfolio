  ...
  return (
    <footer className="relative bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="relative z-10 container mx-auto px-6 pt-16 pb-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center border-b border-gray-800 pb-10">
          <div className="mb-8 lg:mb-0">
            <a href="#" className="inline-block">
              <h2 className="text-2xl font-bold text-white relative">
                ...
                <span className="block h-1 w-1/2 bg-purple-500 mt-1"></span>
              </h2>
            </a>
          </div>
          ...
          <div className="hidden lg:flex space-x-4 mt-8 lg:mt-0">
            <a
      ...
      {showTopButton && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 p-3 rounded-full bg-purple-600/80 backdrop-blur-sm text-white shadow-lg hover:bg-purple-700 transition-all"
