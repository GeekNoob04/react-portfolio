    ...
    <section className="relative min-h-screen flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -inset-[10px] opacity-50">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-lg max-h-lg bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 blur-3xl rounded-full animate-spin-slow" />
        </div>
      </div>

      <div className="container mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto backdrop-blur-sm p-8 rounded-xl">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a
              href="#projects"
              className="px-6 py-3 border border-purple-500 rounded-full font-medium hover:bg-purple-500/20 transition-colors"
            >
              View Projects
            </a>
          </div>
