                    ...
                    <div className="space-y-4 md:space-y-6 text-base md:text-lg">
                        {isMobile ? (
                            <p className="text-gray-200 leading-relaxed">
                                I'm a passionate fourth-year B.Tech student
                                specializing in Data Science. I'm enthusiastic
                                about front-end web development, with skills in
                                data structures and algorithms, helping me write
                                efficient code.
                            </p>
                        ) : (
                            <>
                                <p className="text-gray-200 leading-relaxed">
                                    I'm a passionate fourth-year B.Tech student
                                    specializing in Data Science, with a strong
                                    foundation in both theoretical concepts and
                                    practical applications. I'm particularly
                                    enthusiastic about front-end web
                                    development, where I enjoy bringing
                                ...
                                <p className="text-gray-200 leading-relaxed">
                                    ...
                                    developed a solid grasp of data structures
                                    and algorithms, which helps me write
                                    efficient and optimized code. I'm also
                                    deeply interested in data science, where I
                                    love uncovering insights from data and
                                    building intelligent solutions. I'm always
                                    eager to explore new technologies,
                                    frameworks, and tools that help me grow and
                                    stay ahead in this ever-evolving tech
                                    landscape.
                                </p>
                            </>
                        )}
